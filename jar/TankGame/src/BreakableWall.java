...
public class BreakableWall extends JComponent {
	...
	public BreakableWall(TankRotationExample tre, BufferedImage img, int x, int y ) {
		this.tre = tre;
		BreakableWall.img = img;
		this.x = x;
		this.y = y;
		this.bounds = new Rectangle(x, y, BreakableWall.img.getWidth(), BreakableWall.img.getHeight());
	}
	...
	public void printBounds() {
		System.out.println("BreakableWall bounds: " + this.bounds);
	}
	
	public void printXY() {		
		System.out.println("BreakableWall x: " + this.x + " y: " + this.y);
	}
	
	public void drawImage(Graphics g) {
		//this.printXY();
		g.drawImage(img, this.x, this.y, BreakableWall.img.getWidth(), BreakableWall.img.getHeight(), null);
	}
	...
	public void CollidesWithBullet() {
		if(this.tre.bullet != null) {
			if(this.tre.bullet.getBounds().intersects(this.bounds)) {
				this.tre.brkWallList.remove(this.tre.brkWallObj);
